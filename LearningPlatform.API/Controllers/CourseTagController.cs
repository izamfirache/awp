...
namespace LearningPlatform.API.Controllers
{
	public class CourseTagController : ApiController
	{
		...
		{
			_repository = new DataRepository<CourseTag>(Environment.GetEnvironmentVariable("AWP_DB", EnvironmentVariableTarget.Machine));
		}
		...
		[HttpGet]
		public IHttpActionResult GetTagsForCourseId([FromUri]int courseId)
		{
